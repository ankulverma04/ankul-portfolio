...
export default function About() {
  const tools = [
    { name: "vscode", icon: vsImg },
    { name: "firebase", icon: fireImg },
  ...
  const data = [
    ...
    },
    {
      ...
      description: "B.Tech in Computer Science (DS + AI)",
    },
    {
      name: "Projects",
      icon1: proIcon,
  ...
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      <h4 className="text-center mb-2 pt-[4.5rem] text-lg font-Ovo">Introduction</h4>
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I completed a 6-month apprenticeship in Full Stack (MERN)
            Development at Techpile Technology Pvt. Ltd., gaining hands-on
