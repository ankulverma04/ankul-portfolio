...
export default function Services() {
    ...
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am a full stack developer from Lucknow,6-8 month of Apperetenship experience in Techpile Technology Private Limited</p>
